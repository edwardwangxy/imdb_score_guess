...
#' 4. Removed all temporary objects created and save rawdata objects into files for future load to save time.
...
raw_save_list = c(raw_save_list,"max_movies_pick")
...
#' 2. Combine all training reviews into a large training dataset.
#' 3. Generate a training term frequency table with scores and save all term names into list.
#' 4. Use the test review dataset above and create a test term frequency table using training term names.
#' 5. Use the training table create a classification tree and plot it.
#' 6. Pruned the tree and plot the pruned tree.
#' 7. Predict movie scores using two trees.
